        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CidadeDestinoId = table.Column<int>(nullable: false),
                    CidadeOrigemId = table.Column<int>(maxLength: 255, nullable: false),
                    DataChegada = table.Column<DateTime>(nullable: false),
                    DataPartida = table.Column<DateTime>(maxLength: 255, nullable: false),
                    TripulacaoId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CidadeDestino", x => x.CidadeDestinoId);
                    table.ForeignKey(
                        name: "FK_CidadeDestino_Voo_VooId",
                        column: x => x.VooId,
                        principalTable: "Voo",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CidadeOrigemId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Nome = table.Column<string>(maxLength: 255, nullable: false),
                    VooId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CidadeOrigem", x => x.CidadeOrigemId);
                    table.ForeignKey(
                        name: "FK_CidadeOrigem_Voo_VooId",
                        column: x => x.VooId,
                        principalTable: "Voo",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CidadeDestino_VooId",
                table: "CidadeDestino",
                column: "VooId");

            migrationBuilder.CreateIndex(
                name: "IX_CidadeOrigem_VooId",
                table: "CidadeOrigem",
                column: "VooId");
